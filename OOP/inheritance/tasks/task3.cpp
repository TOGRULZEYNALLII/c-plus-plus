...
class ProjectTeamMember : private Project, private TeamMember {
    // ... (Same as provided code)
    public:
        ...
        ProjectTeamMember() : Project("Untitled Project"), TeamMember("Unnamed Member") {}


};

class TeamMemberTask : private TeamMember, private Task {
    // ... (Same as provided code)
    ...
    public:
        ...
        TeamMemberTask() : TeamMember("Unnamed Member"), Task("Untitled Task") {}
};
...
int main() {
    ...
    ProjectTeamMember ptm("Project X", "Alice");
        ProjectTeamMember asa("Project Y", "Bob");
            ProjectTeamMember asdd("Project Z", "Charlie");
    TeamMemberTask tmt("Bob", "Code Review");

    cout << "Project Team Member Information:" << endl;
    ptm.displayProjectTeamMember();
    asa.displayProjectTeamMember();
    asdd.displayProjectTeamMember();
