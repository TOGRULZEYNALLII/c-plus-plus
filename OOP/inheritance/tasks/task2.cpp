...
virtual void displayInfo()
{
    ...
    cout << "authorOrDirector: " << authorOrDirector << endl;
    cout << "publicationYear: " << publicationYear << endl;

}
    LibraryItem(string t, string a, int p) : title(t), authorOrDirector(a), publicationYear(p) {}
...
public:
    Book(string t, string a, int p, string i) : LibraryItem(t, a, p), isbn(i) {}
...
public:
    DVD(string t, string a, int p, int r) : LibraryItem(t, a, p), runtime(r) {}
