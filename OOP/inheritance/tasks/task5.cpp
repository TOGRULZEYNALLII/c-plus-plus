...
*/
    ...
    public:
        Base(int accNum, const string& accHolder, double bal)
...
class SavingsAccount : public Base {
    public:
        SavingsAccount(int accNum, const string& accHolder, double bal)
            : Base(accNum, accHolder, bal) {}
...
class CheckingAccount : private Base {
    public:
        CheckingAccount(int accNum, const string& accHolder, double bal)
            : Base(accNum, accHolder, bal) {}
...
class CreditCardAccount : private Base {
    public:
        CreditCardAccount(int accNum, const string& accHolder, double bal)
            : Base(accNum, accHolder, bal) {}
