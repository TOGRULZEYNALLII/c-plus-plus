...
public:
    Character(const string& name, int level, int exp) 
        : GameObject(name), level(level), experience(exp) {}
...
int main() {
    ...
    Character character("Adventurer", 5, 200);
