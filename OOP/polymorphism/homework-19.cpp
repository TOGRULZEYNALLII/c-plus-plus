...
int main() {
    ...
    //m,enim cavabim : compile-time polymorphism, cunku metodlarin imzasi (signature) ferqlidir
    ...
    // Guess: Is this an example of compile-time or run-time polymorphism?
    //m,enim cavabim : compile-time polymorphism, cunku operator overloading compile-time polymorphism-in bir formudur
    result = c1 + c2;
    ...
    // Guess: Is this an example of compile-time or run-time polymorphism?
    //m,enim cavabim : run-time polymorphism, cunku virtual function ve inheritance istifade olunur
